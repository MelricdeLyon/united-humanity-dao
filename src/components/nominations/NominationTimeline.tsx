...
const ElectionTimeline: React.FC<ElectionTimelineProps> = ({ election }) => {
      ...
      <div className="grid gap-4">
        ...
        <div className="flex items-center gap-4 p-4 rounded-lg border">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              Chaque citoyen peut nominer librement une personne de son choix
            </p>
        ...
        <div className="flex items-center gap-4 p-4 rounded-lg border">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              Les plus nominés présentent leur vision, pétitions possibles pour nouveaux candidats
            </p>
            <div className="flex items-center gap-4 text-xs text-muted-foreground">
              <div className="flex items-center gap-1">
                <Calendar className="h-3 w-3" />
