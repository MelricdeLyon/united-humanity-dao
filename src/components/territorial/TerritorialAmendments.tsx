...
const mockAmendments = [
  ...
  },
  {
    ...
    deadline: "2024-03-25",
    description: "Réduction du budget de 50M JRC en reportant certains aménagements à la phase 2.",
    originalText: "Budget total: 250M JRC",
    amendedText: "Budget phase 1: 200M JRC, Phase 2: 50M JRC (2026)",
    budgetImpact: "-500000",
  ...
  },
  {
    ...
    deadline: "2024-03-15",
    description: "Intégration d'un module de traçabilité blockchain pour chaque JRC dépensé.",
