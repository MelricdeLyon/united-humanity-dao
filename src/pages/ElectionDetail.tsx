...
import NominationRound from '@/components/elections/NominationRound';
import PreselectRound from '@/components/elections/PreselectRound';
import FinalRound from '@/components/elections/FinalRound';
